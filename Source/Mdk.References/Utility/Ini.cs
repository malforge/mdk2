...
namespace Mdk2.References.Utility
{
    ...
    public class Ini
    {
        ...
        /// <returns></returns>
        public Ini WithTrailingTrivia(string trivia) => new Ini(_sections, trivia);
        
        /// <summary>
        /// Creates a clone of the current instance without a trailing comment.
        /// </summary>
        /// <returns></returns>
        public Ini WithoutTrailingTrivia() => new Ini(_sections);
        ...
        public static bool TryParse(string ini, out Ini result)
        {
            ...
            bool tryReadLine(string text, ref int i, out string line)
            {
                var start = i;
                ...
                if (i < text.Length && text[i] == '\n')
                    i++;
                line = text.Substring(start, i - start);
                if (line.EndsWith("\r\n"))
            ...
            while (tryReadLine(ini, ref index, out var line))
            {
                ...
                if (trimmed.StartsWith("[") && trimmed.EndsWith("]"))
                {
                    ...
                    currentSection = new Section(trimmed.Substring(1, trimmed.Length - 2));
                    if (comment.Length <= 0)
                        continue;
                ...
                else if (!(currentSection is null))
                {
                    ...
                    if (comment.Length > 0)
                        currentSection = currentSection.Value.WithKey(key, value).WithComment(comment.ToString());
                    else
                        currentSection = currentSection.Value.WithKey(key, value);
                    comment.Clear();
                    addNewline = false;
                }
            }
        ...
        /// <param name="section"></param>
        /// <returns></returns>
        public Ini WithSection(Section section) => new Ini(_sections.SetItem(section.Name, section));
        ...
        /// <returns></returns>
        public Ini WithSection(string name, Func<Section, Section> buildSection) => new Ini(_sections.SetItem(name, buildSection(this[name])));
        ...
        /// <returns></returns>
        public Ini WithSection(string name, IEnumerable<Key> keys) => new Ini(_sections.SetItem(name, new Section(name, keys)));
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public Ini WithoutSection(string name) => new Ini(_sections.Remove(name));
        ...
        public readonly struct Section
        {
            ...
            /// <param name="key"></param>
            /// <returns></returns>
            public Section WithKey(Key key) => new Section(Name, Keys.SetItem(key.Name, key), LeadingComment);
            ...
            /// <param name="value"></param>
            /// <returns></returns>
            public Section WithKey(string name, string value) => new Section(Name, Keys.SetItem(name, new Key(name, value, null)), LeadingComment);
            ...
            /// <param name="name"></param>
            /// <returns></returns>
            public Section WithoutKey(string name) => new Section(Name, Keys.Remove(name), LeadingComment);
            ...
            /// <returns></returns>
            public Section WithComment(string comment) => new Section(Name, Keys, comment);
            
            /// <summary>
            /// Creates a clone of the current instance without a leading comment.
            /// </summary>
            /// <returns></returns>
            public Section WithoutComment() => new Section(Name, Keys);
        ...
        public readonly struct Key
        {
            ...
            /// <param name="comment"></param>
            /// <returns></returns>
            public Key WithComment(string comment) => new Key(Name, Value, comment);
            
            /// <summary>
            /// Creates a clone of the current instance without a comment.
            /// </summary>
            /// <returns></returns>
            public Key WithoutComment() => new Key(Name, Value, null);
            ...
            /// <param name="value"></param>
            /// <returns></returns>
            public Key WithValue(string value) => new Key(Name, value, Comment);
            
            /// <summary>
            /// Creates a clone of the current instance without a value.
            /// </summary>
            /// <returns></returns>
            public Key WithoutValue() => new Key(Name, null, Comment);
