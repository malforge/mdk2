...
public class SymbolDefinitionInfo
{
    ...
    /// </summary>
    /// <returns></returns>
    public SymbolDefinitionInfo AsProtected() => new(Symbol, SyntaxNode, true, Usage);

    /// <summary>
    ///     Creates an unprotected copy of this symbol definition
    /// </summary>
    /// <returns></returns>
    public SymbolDefinitionInfo AsUnprotected() => new(Symbol, SyntaxNode, false, Usage);
    ...
    /// <param name="usage"></param>
    /// <returns></returns>
    public SymbolDefinitionInfo WithUsageData(ImmutableArray<ReferencedSymbol> usage) => new(Symbol, SyntaxNode, IsProtected, usage);
