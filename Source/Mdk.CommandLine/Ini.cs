...
public class Ini
{
    ...
    public static bool TryParse(string? ini, out Ini result)
    {
        ...
        while (tryReadLine(ini, ref index, out var line))
        {
            ...
            else if (currentSection is not null)
            {
                ...
                if (equals < 0)
                    continue;
                var key = trimmed.Slice(0, equals).Trim();
                var value = trimmed.Slice(equals + 1).Trim();
                if (comment.Length > 0)
    ...
    public readonly struct Key
    {
        ...
        /// <summary>
        /// Attempts to read the raw value as a short integer. Returns the default value if the value is null or cannot be parsed.
        /// </summary>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public short ToShort(short defaultValue = 0)
        {
            if (Value is null)
                return defaultValue;
        ...
        /// <summary>
        /// Attempts to read the raw value as an unsigned integer. Returns the default value if the value is null or cannot be parsed.
        /// </summary>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Attempts to read the raw value as a signed byte. Returns the default value if the value is null or cannot be parsed.
        /// </summary>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Attempts to read the raw value as a char. Returns the default value if the value is null or cannot be parsed.
        /// </summary>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
