...
{
    /// <summary>
    ///     The name of the project. This is not necessarily the same as the name of the .csproj file, and is not guaranteed to
    ///     be unique. It is intended for display purposes only.
    /// </summary>
